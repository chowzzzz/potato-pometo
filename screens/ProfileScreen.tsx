...
const ProfileScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.cardsview} showsVerticalScrollIndicator={false}>
        <View style={styles.card}>
          ...
          <Text style={styles.biotext}>💼: Tech Intern Feb - July</Text>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.biotext}>
            Hiii i love dancing especially hip hop! Sushi is my favourite and
            one fun fact about is I like to drink milo at night! Hit me up if
            you wanna dance and chill together (:
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={{ flexDirection: "column" }}>
            <Text style={styles.biotext}>My personality type is... </Text>
            <Text style={{ fontWeight: "bold", marginTop: 7, fontSize: 16 }}>
              SWAGGER THE CARER
            </Text>
          </View>
